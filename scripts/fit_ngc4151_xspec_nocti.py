...
parser.add_argument('--output', type=str, default="output_xspec_fit2.csv",
...
#
logfile = xspec.Xset.openLog("{}_{}_xspec_fit2.log".format(target,inst))
#
#file_out = os.path.join(wdir,args.output)
file_out = os.path.join(wdir,'output_xspec_nocti_fit2.csv')
#
