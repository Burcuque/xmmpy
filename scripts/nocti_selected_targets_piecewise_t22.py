...
#
hdu = fits.open("/home/ivaltchanov/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test24")
...
plt.savefig(f'{wdir}/linear_extrapolation_t25.png',dpi=100)
plt.show()
plt.close()
#%%    
#
...
hdu = fits.open("/home/ivaltchanov/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test26")
# test4 is the previous correction with no extrapolation for the reference energy
...
#
ccf49_file = '/home/ivaltchanov/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test22'
...
hdu49.writeto("/xdata/xcaldata/XMM/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test24",overwrite=True)
