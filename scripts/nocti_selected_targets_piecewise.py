...
plt.savefig(f'{wdir}/linear_extrapolation_t7x.png',dpi=100)
plt.show()
plt.close()
#%%    
#
...
hdu = fits.open("/home/ivaltchanov/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test7")
# test4 is the previous correction with no extrapolation for the reference energy
...
#ax.plot(tt,corr3,'b-',label='Previous correction curve')
...
ax.plot(tt,result,'r-', label='Correction for 6.4 keV, RAWY=190')
...
plt.savefig(f'{wdir}/correction_with_extrapolation_t8.png',dpi=100)
plt.show()
plt.close()
#%%
#
...
#%%
hdu49.writeto("/xdata/xcaldata/XMM/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test8",overwrite=True)
