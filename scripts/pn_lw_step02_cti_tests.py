...
Step 02 of PN SW processing:  running epchain with the new testing CCF.
...
#
# get the arguments
parser = argparse.ArgumentParser(description='XMM SAS step02 with no CTI for PN LW, running epchain')
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pn_lw_step02_{subfolder}.log'),
                    filemode='w')
#
...
os.chdir(ppsDir)
#
xtask = f"epchain odf={odfdir} withctilongterm=Y odfaccess=all backgroundtres=N "
...
if (status != 0):
    ...
    raise Exception
#
print (f"*** step02 done for {obsid} and testing CCF.")
logging.info (f"*** step02 done for {obsid} and testing CCF.")
#
