...
for j in np.unique(rev):
    ...
    ax[0].fill([istart-1,istart+3,istart+3,istart-1], [ymin,ymin,ymax,ymax], 'grey', alpha=0.2, edgecolor='r')
    ax[1].text(istart,ratmin,j)
    ax[1].fill([istart-1,istart+3,istart+3,istart-1], [ratmin,ratmin,ratmax,ratmax], 'grey', alpha=0.2, edgecolor='r')
    istart += 10
#
...
ax[1].set_xlabel("Revolution index")
