...
parser.add_argument('subfolder', type=str,
                    help='The subfolder where the products are.')
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,f'pn_lw_step03_doubles_{subfolder}.log'),
                    filemode='w')
#
...
#
logging.info (f"pn_lw_step03_ccd_doubles {subfolder} done")
#
