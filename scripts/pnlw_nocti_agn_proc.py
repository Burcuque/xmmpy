...
PN LW processing:  running epchain with no Long-term CTI, using source and background regions for AGNs
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pnlw_nocti_agn_proc.log'),
                    filemode='w')
#
...
if (status != 0):
    raise Exception
#
logging.info ("pnlw_nocti_agn_proc done")
#
