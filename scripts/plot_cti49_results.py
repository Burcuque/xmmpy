...
v48 = Table.read('{}/../PN_calclosed/Jan2018/PN_SW_fit_results.csv'.format(wdir))
n48 = len(v48)
v49 = Table.read('{}/../PN_calclosed/pn_sw_calclosed_fit_results_cti49x.csv'.format(wdir))
n49 = len(v49)
...
plt.savefig(f'{wdir}/pn_fit_results_cti49x.png',dpi=100)
plt.show()
plt.close()
