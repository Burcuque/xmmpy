...
Fit the CalClosed lines with XSPEC, select which grouping to use
...
parser.add_argument('spec_file', type=str,
                    help='The spectrum file to read')
...
#
#spec_file = 'pn_spectrum_grp0.fits'
#
try:
...
#
logfile = xspec.Xset.openLog(f"cc_xspec_{var}.log")
#
#file_out = os.path.join(wdir,args.output)
...
#
psfile = f"{wdir}/spectral_fit/pn_{obsid}_xspec_{var}.ps".format(wdir,obsid,inst)
...
p11error = (par11.error[1] - par11.error[0])/2.0
#
