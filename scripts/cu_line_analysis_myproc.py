...
# file for output
#
fout = open(f"{outputDir}/fit_results_cuka_myproc.csv","w")
#
...
for ik,iobs in enumerate(obslist):
    ...
    for j in range(12):
        ...
        slices = f"{outputDir}/{obsid}/PN_LW/pn_{ccd}_all_spec5.fits"
    ...
    #plt.tight_layout()
    plt.savefig(f"{plotDir}/{obsid}_CuKa__myproc_plot.png",dpi=100)
    #plt.show()
    plt.close()
#
fout.close()
