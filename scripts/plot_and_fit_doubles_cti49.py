...
Using spectre with only double events (PATTERN in [1:4])
...
#
#
spec_file = "pn_spectrum_doubles_cti49_grp0.fits"
...
#
logfile = xspec.Xset.openLog(f"{target}_pn_xspec_doubles_cti49.log".format(target,inst))
#
...
#
psfile = f"{wdir}/spec_fit/{obsid}_{inst}_fit_doubles_cti49.ps"
...
tout.write(f"{wdir}/{obsid}_xspec_doubles_dump.csv",overwrite=True)
#
