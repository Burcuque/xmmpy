...
corr2x137 = np.power((1.0 - tcoeff2)/(1.0 - tcoeff2[0]),137.0)
corr2x200 = np.power((1.0 - tcoeff2)/(1.0 - tcoeff2[0]),200.0)
...
ax.plot(tt,corr2x137,'b:',label='Correction for 5.9 keV, RAWY=137')
ax.plot(tt,corr2x200,'b:',label='Correction for 5.9 keV, RAWY=200')
