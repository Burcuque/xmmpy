...
Step 03 of PN LW processing:  extract spectra from a spatial filter with mask 
 from Michael Smith and only double events, i.e. PATTERN in [1,4]
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pn_lw_step03_doubles_cti49.log'),
                    filemode='w')
#
...
for i in range(12):
    ...
    spec_file = f"pn_{ccd}_doubles_spec5.fits"
    command = "evselect " + \
...
#
logging.info ("pn_lw_step03_ccd_doubles cti49 done")
#
