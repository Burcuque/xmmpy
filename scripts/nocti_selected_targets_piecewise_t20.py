...
#
hdu = fits.open("/home/ivaltchanov/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test20")
...
plt.savefig(f'{wdir}/linear_extrapolation_t20.png',dpi=100)
plt.show()
plt.close()
#%%    
#
...
plt.savefig(f'{wdir}/correction_with_extrapolation_t20.png',dpi=100)
plt.show()
plt.close()
#%%
#
...
#%%
hdu49.writeto("/xdata/xcaldata/XMM/IVAN/PN_SW/ccfdev/EPN_CTI_0049.CCF_test9",overwrite=True)
