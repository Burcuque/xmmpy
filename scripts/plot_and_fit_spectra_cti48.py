...
parser.add_argument('--ppsDir', type=str, default='cti48',
                    help='Name of PPS folder')
parser.add_argument('--line', type=float, default=6.3,
                    help='Initial line enery in keV')
parser.add_argument('--output', type=str, default="output_xspec_cti48.csv",
...
#
#
spec_file = "{}_spectrum_cti48_grp0.fits".format(inst)
...
#
logfile = xspec.Xset.openLog("{}_{}_xspec_cti48.log".format(target,inst))
#
...
#
psfile = "{}/spec_fit/{}_{}_fit_cti48.ps".format(wdir,obsid,inst)
