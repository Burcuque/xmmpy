...
Using the even list with no Long-term CTI in folder nocti
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pn_lw_step03_ccd_nocti.log'),
                    filemode='w')
#
...
if (not os.path.isfile(ccffile)):
    ...
    print ("     ===> This means pn_lw_step01.py was not run?")
...
for i in range(12):
    ...
    new_events = f"pn_{ccd}_cuka_events.fits"
    ...
    print (f"{obsid},{ccd},{mean_rawy:.2f},{nevents}",file=fout)
    hdu.close()
#
print (f"{obsid}: pn_lw_derive_rawy done")
#
