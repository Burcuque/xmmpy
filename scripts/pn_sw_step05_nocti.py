...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pn_sw_step05_nocti.log'),
                    filemode='w')
#
...
#
evlist = os.path.join(ppsDir,'pn_evlist_clean_nocti.fits')
...
#
reg_file = "../PN_SW/pn_sw_regions.reg"
...
command = "rmfgen spectrumset={} rmfset=pn_nocti.rmf".format(src_spec)
