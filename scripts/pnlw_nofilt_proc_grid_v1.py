...
Modification history:
    ...
    v2: will copy the ODF to $TMPDIR and will create the products there
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(wdir,'logs',f'pnlw_nofilt_proc_{obsid}_{subfolder}.log'),
                    filemode='w')
...
if (not os.path.isdir(odfdir)):
    ...
    print (f"Will use ODF folder {odfdir}.")
    logging.info (f"Will use ODF folder {odfdir}.")    
#
...
if (copy_to_node):
    ...
    if (not os.path.isdir(topdir)):
        ...
        os.mkdir(topdir)
    ppsDir = os.path.join(topdir,subfolder)
