...
PN LW processing:  running the EPIC-pn workflow for CalClosed observation
...
parser.add_argument('subfolder', type=str,default="PN_LW",
                    help='The subfolder to use')
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,'pn_lw_cc_proc_{subf}.log'),
                    filemode='w')
#
...
#            raise Exception
    ...
    if (ccd == "04"):
        ...
        hdu.writeto(spec_file,overwrite=True)
#
logging.info (f"pnlw_cc_proc done for {subf}")
#
print ("All done")
