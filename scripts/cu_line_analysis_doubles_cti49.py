...
# file for output
#
fout = open(f"{outputDir}/fit_results_cuka_doubles_cti49_test52.csv","w")
#
...
for ik,iobs in enumerate(obslist):
    ...
    for j in range(12):
        ...
        slices = f"{outputDir}/{obsid}/cti49/pn_{ccd}_doubles_spec5.fits"
    ...
    #plt.tight_layout()
    plt.savefig(f"{plotDir}/{obsid}_CuKa_doubles_cti49_test52_plot.png",dpi=100)
    #plt.show()
    plt.close()
#
fout.close()
