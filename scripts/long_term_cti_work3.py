...
for target in targets:
    ...
    rxerr = lineErr/lineX
    # build up the arrays
    rtime = np.concatenate((rtime,t['delta_time'].data),axis=None)
...
# now the CalClosed
# 
hdu = fits.open('ccfdev/EPN_CTI_0049_test.CCF')
...
hdus = fits.open(f'{wdir}/ccfdev/EPN_CTI_0049_test.CCF')
#
...
hdus.writeto(f"{wdir}/ccfdev/EPN_CTI_0049_test2.CCF",overwrite=True)
