...
model = xspec.Model("po + ga + ga + ga + ga",\
        setPars={3:1.5, 4:1.0e-2, 6:5.9, 5:1.0e-3, 9:6.4, 10:1.0e-3, 12: 8.0, 13:1.0e-3})
#
#
...
model.gaussian_4.Sigma = [5.0e-2,0.001,1.0e-3,1.0e-3,1.0e-1,1.0e-1]
model.gaussian_5.Sigma = [5.0e-2,0.001,1.0e-3,1.0e-3,1.0e-1,1.0e-1]
#
model.gaussian.LineE = [1.48,0.001,1.4,1.4,1.6,1.6]
model.gaussian_3.LineE = [5.899,0.001,5.8,5.8,6.1,6.1]
model.gaussian_4.LineE = [6.4,0.001,6.3,6.3,6.6,6.6]
model.gaussian_5.LineE = [8.0,0.001,7.9,7.9,8.2,8.2]
