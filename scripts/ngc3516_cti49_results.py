...
wdir = "/xdata/xcaldata/XMM/IVAN/PN_SW/ngc3516"
#
feK = 6.399 # keV
#
# NGC 5506
...
v48=v48all[ix]
#
v49 = Table.read('{}/output_xspec_cti49x.csv'.format(wdir))
n49 = len(v49)
...
ax.set_title("{} in PN SW mode".format(target.upper()))
ax.legend(loc=2)

plt.savefig(f'{wdir}/{target}_pnsw_cti49_results.png',dpi=100)
plt.show()
plt.close()
