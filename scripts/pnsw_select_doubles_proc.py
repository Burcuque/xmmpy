...
Full workflow for EPIC-PN processing an XMM observation, filtering only double events, i.e.
PATTERN in [1,4]
...
logging.basicConfig(level=logging.DEBUG,
                    ...
                    filename=os.path.join(ppsDir,f'pn_proc_doubles_{subf}.log'),
                    filemode='w')
#
...
# doubles
expr1 = "(FLAG==0) && (PATTERN >= 1) && (PATTERN <= 4)"
#
...
#
src_spec = "pn_src_spectrum_doubles_cti49.fits"
...
#
bg_spec = "pn_bkg_spectrum_doubles_cti49.fits"
...
rmf_set = "pn_doubles_cti49.rmf"
command = f"rmfgen spectrumset={src_spec} rmfset={rmf_set}"
...
arf_set = "pn_doubles_cti49.arf"
command = f"arfgen spectrumset={src_spec} arfset={arf_set}" + \
    f" withrmfset=yes rmfset={rmf_set}" + \
    f" badpixlocation={filt_evlist} detmaptype=psf"
...
#
group0_set = "pn_spectrum_doubles_cti49_grp0.fits"
command = f"specgroup spectrumset={src_spec} addfilenames=yes rmfset={rmf_set}" + \
    f" arfset={arf_set} backgndset={bg_spec} groupedset={group0_set}"
